...
public class Pedido {
    ...
    public synchronized double calcularSubtotal(){
        double subtotal = 0;
    ...
    public synchronized double calcularDescuento(){
    ...
    // SINCRONIZADO
    public synchronized void confirmarPedido() throws PedidoInvalidoException, StockInsuficienteException {
    ...
    // SINCRONIZADO
    public synchronized void mostrarDetalle(){
